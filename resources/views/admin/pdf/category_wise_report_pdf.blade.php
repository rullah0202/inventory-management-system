...
@section('heading','Category Wise Stock Report')
...
<div class="table-responsive">
    ...
    <h3 class="text-center"><strong>Category Name : </strong> {{ $allData['0']['category']['category_name'] }} </h3>
...
@else
    <div class="text-danger">"There is no data"</div>
@endif
